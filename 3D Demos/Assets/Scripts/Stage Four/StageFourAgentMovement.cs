...
public class StageFourAgentMovement : MonoBehaviour
{
    ...
    private void normalizePosition()
    {
        ...
        searchLight.searchLight.range = viewRadius; 

        if (viewAngle > 179)
        {
            searchLight.rotationAngle = viewAngle / 2;
        }

        else
        {
            searchLight.rotationAngle = viewAngle;
        }
    }
